...
: TildeNode("longitudinal_controller", node_options)
{
  ...
  m_sub_current_velocity = create_tilde_subscription<nav_msgs::msg::Odometry>(
    "~/input/current_odometry", rclcpp::QoS{1},
    std::bind(&LongitudinalController::callbackCurrentVelocity, this, _1));
  m_sub_trajectory = create_tilde_subscription<autoware_auto_planning_msgs::msg::Trajectory>(
    "~/input/current_trajectory", rclcpp::QoS{1},
    std::bind(&LongitudinalController::callbackTrajectory, this, _1));
  m_pub_control_cmd = create_tilde_publisher<autoware_auto_control_msgs::msg::LongitudinalCommand>(
    "~/output/control_cmd", rclcpp::QoS{1});
  m_pub_slope = create_tilde_publisher<autoware_auto_system_msgs::msg::Float32MultiArrayDiagnostic>(
    "~/output/slope_angle", rclcpp::QoS{1});
  m_pub_debug = create_tilde_publisher<autoware_auto_system_msgs::msg::Float32MultiArrayDiagnostic>(
